...
export function TransportHeroScene({ run, stage, theme, onRevealComplete }: TransportHeroSceneProps) {
  ...
  useEffect(() => {
    ...
    scene.fog = new THREE.FogExp2(dark ? 0x0d1c27 : 0xe7ecee, 0.032);
    ...
    renderer.setClearColor(dark ? 0x0d1c27 : 0xe7ecee, 1);
    renderer.outputColorSpace = THREE.SRGBColorSpace;
    renderer.toneMapping = THREE.AgXToneMapping;
    renderer.toneMappingExposure = dark ? 0.88 : 1.05;
    ...
    const ground = new THREE.Mesh(
      ...
      new THREE.MeshStandardMaterial({ color: dark ? 0x1b2d37 : 0xdde4e1, roughness: 1, metalness: 0 }),
    );
