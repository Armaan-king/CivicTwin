...
export function buildNodes(run: SimulationRun | null): SysNode[] {
  ...
  return [
    ...
    { id: "voice", label: "Deliberation agent", kind: "the engine", group: "agents",
      ...
      facts: [{ label: "batch", value: "12 residents" }, { label: "rounds", value: "4" }],
    ...
    { id: "sim", label: "Rules engine", kind: "V1, being removed", group: "engine",
      state: "planned", path: "backend/app/simulation.py",
      detail: "Seven deterministic rules that used to decide who was harmed. V2 hands that judgement to the residents themselves, so this is on its way out; the metrics and interventions still read it while they are ported.",
